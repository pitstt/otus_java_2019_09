...
public class DbExecutor<T> {
    ...
    public Optional<Object> selectRecord(Connection connection, String sql, long id, Function<ResultSet, T> rsHandler) throws SQLException {
