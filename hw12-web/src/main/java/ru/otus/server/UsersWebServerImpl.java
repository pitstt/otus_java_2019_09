...
public class UsersWebServerImpl implements UsersWebServer {
    ...
    public UsersWebServerImpl(int port, SecurityType securityType,
                              ...
                              LoginService loginServiceForBasicSecurity, HibernateTemplate hibernateTemplate,
                              Gson gson,
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new UsersServlet(templateProcessor, hibernateTemplate)), "/users");
        servletContextHandler.addServlet(new ServletHolder(new UsersApiServlet(hibernateTemplate, gson)), "/api/user");
